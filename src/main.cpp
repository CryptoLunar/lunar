...
unsigned int nStakeMinAge = 4 * 60 * 60; // 1 hours
...
const string strMessageMagic = "Lunar Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Lunar", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Sat, 17 Oct 2015 23:54:22 GMT";
        CTransaction txNew;
        txNew.nTime = 1445126062;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1445126062;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 62017560 : 62017560;



        assert(block.hashMerkleRoot == uint256("0x8ed93aa3340c7f20b057e916cd4765f6704efb71bd5272cfe678ca3b15a1b3e4"));
...
unsigned char pchMessageStart[4] = { 0x6d, 0xf9, 0xe6, 0xa4 };
